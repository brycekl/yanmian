...
def main(args):
    ...
    model_names = ['unet', 'vgg16unet', 'mobilev3unet', 'resnet34unet', 'u2netlite', 'u2netfull'] * 2
    for model_name in model_names:
        # name = 'lr_' + str(lr)
        output_dir = args.output_dir.replace('tempmodel', model_name)
        # args.lr = lr
...
if __name__ == "__main__":
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='./model/model_test/c10/backbone_test3/tempmodel_c3_bc32_2x16_50e',
